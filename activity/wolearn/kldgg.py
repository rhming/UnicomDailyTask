...
class KldggAct(WoLearn):

    def __init__(self, mobile, password):
        super(KldggAct, self).__init__(mobile, password)
        self.chc = "ByIGdlNkD3ZbMQxtVmUBMVY0BH1cMQ"
    ...
    def getReward(self, item):
        url = 'https://edu.10155.com/wxx-api/Api/KldggAct/getReward'
        data = {
            "p": "",
    ...
    def raffle(self):
        url = 'https://edu.10155.com/wxx-api/Api/KldggAct/raffle'
        data = {
            "p": "",
            "chc": self.config.get('chc'),
            "jrPlatform": "ACTIVITY",
    ...
    def userActInfo(self, debug=False):
        url = 'https://edu.10155.com/wxx-api/Api/KldggAct/userActInfo'
        data = {
            "p": "",
            "chc": self.config.get('chc'),
            "jrPlatform": "ACTIVITY",
    ...
    def addRaffleChance(self, orderId, tip):
        url = 'https://edu.10155.com/wxx-api/Api/KldggAct/addRaffleChance'
        data = {
            "p": "",
            "chc": self.config.get('chc'),
            "jrPlatform": "ACTIVITY",
    ...
    def run(self):
        ...
        if not self.isLogin or self.config['timestamp'][:8] != self.now_date.replace('-', ''):
            ...
            self.openPlatLineNew(
                'https://edu.10155.com/wact/kldgg.html?jrPlatform=SHOUTING&chc=ByIGdlNkD3ZbMQxtVmUBMVY0BH1cMQ&vid=-1'
            )
        ...
        if lottery_times == 0 or lottery_times == lottery_chance:
            ...
            options = {
                ...
                'arguments2': '',
                'codeId': 946878493,
                'channelName': 'android-短视频激励广告活动3-激励视频',
                'remark': '教育频道刮奖活动-激励视频',
